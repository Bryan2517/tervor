...
export function OrganizationSwitcher({ 
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {organizations.length > 1 && (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            {organizations.slice(0, showAllOrgs ? organizations.length : 3).map((org) => {
            ...
            {organizations.length > 3 && !showAllOrgs && (
            ...
            {showAllOrgs && organizations.length > 3 && (
      ...
      {/* Single Organization - Just show logout */}
      {organizations.length === 1 && (
